            ...
            <div class="post-body center">
                <div class="post-rows">
                    <div class="post-top-container"> 
                        ...
                        <i class="post-top-handle"> {this.state.handle}:{this.props.user} </i>
                        <i class="post-top-date"> {this.state.date} </i>
                    </div>  
...
{/* 
                <span class="post-arrows">
                    <a class="post-arrow-up" onClick={e=>this.like(e)}>      <i class="fas fa-arrow-up"></i></a>
                    <a class="post-total-likes-text">   {this.state.total_likes}  </a>
                    <a class="post-arrow-down" onClick={e=>this.dislike(e)}> <i class="fas fa-arrow-down"></i></a>
                </span>
