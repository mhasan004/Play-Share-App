        ...
        return(
            <div class="post-body center">
                ...
                <div class="post-actions-constainer ">
                    ...
                    <svg class="post-comment" onClick={e=>this.commentHandler(e)} width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {show_actions ? (
                        <span class="post-actions-right">
                              <svg class="post-edit" onClick={e=>this.editHandler(e)} width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="post-delete" onClick={e=>this.deleteHandler(e)} width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
