...
/*fill={svg_stroke_color}/>*/
        return(
            ...
            <div class="post-card-body center">
                <div class="post-card-left">
                    ...
                    <div class="PCL-row  PCL-row-3 PCL-body">               
                        {this.state.isURL ? (
                            <div class="PCL-content-img" style={{backgroundImage: `url(${this.state.content})`}}></div >
                        ) : (
                            <h1 class="PCL-content-text">{this.state.content}</h1>
                        )} 
                    </div> 
                    <div class="PCL-row-4 PCL-comment" onClick={e=>this.commentHandler(e)} >       
                        <svg class="PCL-comment-elem" width="45" height="40" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="post-card-right noselect">
                    ...
                    <span class="PCR-action PCR-action-1 center">
                        <svg class="PCR-arrow-up PCR-arrows" onClick={e=>this.likeHandler(e)} viewBox="0 0 44 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg class="PCR-arrow-down PCR-arrows" onClick={e=>this.dislikeHandler(e)} viewBox="0 0 44 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {show_actions ? (
                        <span class="PCR-action PCR-action-2">
                              <svg class="PCR-edit" onClick={e=>this.editHandler(e)} width="2rem" height="2rem" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="PCR-delete" onClick={e=>this.deleteHandler(e)} width="2rem" height="2rem" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
