...
* This REST API will be the server for my social media app which will mimic the functionality of Reddit. The Client and Server Sides are still in production
