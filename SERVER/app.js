...
const {verifyUser, verifyAdmin, verifyApp} = require('./helpers/verifyPermissions')                                                     // PRIVATE ROUTE MIDDLEWARE: Import the Private Routes Middleare      
...
if (process.env.USE_TLS === "True"){
    ...
    app.use('/api/v1/auth', decryptBody, decryptSelectedHeader)                                                                         // (Can disable when using HTTPS) My MIDDLEWARES to decrypt body and some headers for login and request
}
